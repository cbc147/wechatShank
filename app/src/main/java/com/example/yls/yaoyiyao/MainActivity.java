...
package com.example.yls.yaoyiyao;
...
public class MainActivity extends AppCompatActivity implements SensorEventListener{
    ...
    private void init() {
        ...
        mWeChatAudio = mSoundPool.load(MainActivity.this,R.raw.weichat_audio,1);
        //获取Vibrator震动服务
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case START_SHAKE:
                    ...
                    //发出提示音
                    mActivity.mSoundPool.play(mActivity.mWeChatAudio, 1, 1, 0, 0, 1);
